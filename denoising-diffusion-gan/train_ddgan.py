    ...
    for epoch in range(init_epoch, args.num_epoch+1):
        ...
        if rank == 0:
            ...
            if args.dataset == 'cifar10':
                ...
                n_row=2
            torchvision.utils.save_image(fake_sample, os.path.join(exp_path, 'sample_discrete_epoch_{}.png'.format(epoch)), normalize=True,nrow = n_row)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--loss', type=str, default='sw',
                        help='sw')
    parser.add_argument('--port', type=str, default='sw',
                        help='sw')
    ...
    if size > 1:
        ...
        for rank in range(size):
            ...
            p = Process(target=init_processes, args=(global_rank, global_size, func, args))
            p.start()
            processes.append(p)
        ...
        init_processes(0, size, func, args)
